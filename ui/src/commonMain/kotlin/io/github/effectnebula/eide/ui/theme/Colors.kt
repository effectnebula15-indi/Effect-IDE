...
class EideColors(
    ...
    val error: Color,
    val warning: Color,
    /** Полоски правок в гаттере: добавлено, изменено, удалено. Цвета IntelliJ. */
    val vcsAdded: Color,
...
val EideDarkColors: EideColors = EideColors(
    ...
    vcsAdded = Color(0xFF5FAD65),
    vcsModified = Color(0xFF375FAD),
...
val EideLightColors: EideColors = EideColors(
    ...
    vcsAdded = Color(0xFF4C9E52),
    vcsModified = Color(0xFF4676C8),
    vcsDeleted = Color(0xFF9AA0A8),
